...
Computer security is about securing computers, programs, and data. 
Three objectives: Confidentiality, Integrity, Availability
Confidentiality:people, Integrity:proccess, Availability:connections


Confidentiality requires authorization in practice, privacy specifies boundries.

cubicles. process and data has it's own cubicle and not everyone can see inside.

Confidentiality means that we do not make a system’s data and its resources
available to everyone. Only authorized people and processes should have access. 
